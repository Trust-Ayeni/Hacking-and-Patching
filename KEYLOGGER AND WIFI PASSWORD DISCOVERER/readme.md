The python scripts i wrote can be converted into exe formats by using the module `pyinstaller`, this can also be used to embed icons for the `.exe` files. You can 
